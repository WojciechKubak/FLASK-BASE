...
class TestEmployeeDataFactoryCreateMethods:
    ...
    def test_if_create_loader_returns_expected_type(self, employee_data_factory: DataFactory) -> None:
        assert isinstance(employee_data_factory.create_loader(), JsonLoader)

    def test_if_create_validator_returns_expected_type(self, employee_data_factory: DataFactory) -> None:
        assert isinstance(employee_data_factory.create_validator(), EmployeeJsonValidator)

    def test_if_create_converter_returns_expected_type(self, employee_data_factory: DataFactory) -> None:
