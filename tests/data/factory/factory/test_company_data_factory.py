...
class TestCompanyDataFactoryCreateMethods:
    ...
    def test_if_create_loader_returns_expected_type(self, company_data_factory: DataFactory) -> None:
        assert isinstance(company_data_factory.create_loader(), JsonLoader)

    def test_if_create_validator_returns_expected_type(self, company_data_factory: DataFactory) -> None:
        assert isinstance(company_data_factory.create_validator(), CompanyJsonValidator)

    def test_if_create_converter_returns_expected_type(self, company_data_factory: DataFactory) -> None:
